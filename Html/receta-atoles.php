...
<body>
    ...
    <section>
        ...
        <div class="container2">
            ...
            <a href="../COMIDAS/atol-de-maiz-tostado.php">
                <div class="card">
                    <img src="../Comida/Atol-de-Maiz-Tostado.jpg">
                    <h4>Arol de maiz tosatados</h4>
                    <p>("Alguna frase")</p><br>
                    <div class="ver"> Ver más</div>
                </div>
            </a>

            <a href="../COMIDAS/atolchuco.php">
                <div class="card">
                    <img src="../Comida/atol-chuco.jpg">
                    <h4>Atol chuco</h4>
                    <p>("alguna frase")</p><br>
                    <div class="ver"> Ver más</div>
                </div>
    ...
    <section>
        ...
        <div class="container2">
            ...
            <a href="../COMIDAS/atolpiñuela.php">
                <div class="card">
