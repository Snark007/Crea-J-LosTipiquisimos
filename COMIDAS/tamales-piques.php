    ...
    <section>
        <div class="recetas">
            ...
            <div class="recetas-letras">
                ...
                <p>
                    ...
                    Como ingrediente principal ocuparemos frijol y nixtamal, El nixtamal consiste en la adición de una solución de cal a una porción de maíz.
                </p>
            </div>
        </div>
        <div class="linea">
        ...
        <div class="ingredientes">
            <div class="ingredientes2">
                ...
                <p>
                <ul type="square">
                    <li> 2 libras de maíz </li><br>
                    <li>3 tazas de frijoles molidos y fritos</li><br>
                    <li> 1/2 Libra de manteca </li><br>
                    <li> Sazonador de pollo y sal al gusto </li><br>
                    <li> Hojas de huerta para cubrirlos</li><br>
                </ul>
                </p>
            </div>
            <div class="ingredientes-pasos">
                ...
                <ol>
                    ...
                    <li>A la masa de maíz le agregamos un poco de agua, de manera que no quede ni muy dura ni muy aguada, también se le agrega sal al gusto, el sazonador de pollo y la manteca (si lo desea puede usar manteca de cerdo), luego debe cocinar esta masa. </li><br>

                    <li>El siguiente paso es preparar las hojas de huerta, que son indispensables para darles un mejor sabor a los tamales, sin embargo, necesitamos que estas hojas estén firmes y para ello debemos ponerlas en el sol hasta que se encuentren un poco tostadas, se recomienda lavar las hojas antes de ponerlas al sol, ya que podrían contener polvo.
                    </li><br>

                    <li>Ahora comienza la preparación de los tamales pisques y para ello se corta un pedazo de hoja de unos 25 centímetros, se agregan dos cucharadas soperas de masa y en el centro se agrega una cucharada de frijoles, luego debe envolver estos ingredientes en la hoja, de manera que no se salga la masa y que quede bien firme, si lo desea puede usar papel plástico para cubrir la hoja del tamal.</li><br>

                    <li> El último paso consiste en colocar los tamales en una olla al fuego, agregándole agua a la olla y dejándolos al fuego por un tiempo de una hora y media hasta que se encuentren bien cocidos.</li><br>
                </ol>
            </div>
        </div>
    </section>
