    ...
    <section>
        ...
        <div class="ingredientes">
            <div class="ingredientes2">
                ...
                <p>
                <ul type="square">
                    <li> 2 libras de frijoles rojos de seda</li>
                    <li> 2 libras de hueso de cerdo</li>
                    <li> Tomate</li>
                    <li> 1 cabeza de ajo</li>
                    <li> Cilantro</li>
                    <li> Consomé de costilla </li>
            ...
            <div class="ingredientes-pasos">
                ...
                <ol>
                    ...
                    <li>Lo primero que debes hacer es picar el tomate en pequeños trozos. Luego también el chile, cilantro y la cebolla picada en pequeños trozos y dejarlos todo juntos en un recipiente. </li><br>
        
                    <li>Ponemos los frijoles en agua a cocinar a fuego medio. Encima de los frijoles echamos los huesos de cerdo. 
                        </li><br>
        
                    <li>Después le echamos los ingredientes picados que tenemos en el recipiente y lo echamos a la olla junto a los frijoles y los huesos.</li><br>
    
                    <li>Luego le echamos los dientes de ajos ya pelados. y revolvemos para que todo se disperse bien en toda la olla.</li><br>
    
                    <li>Ahora esperamos que los frijoles se ablanden, este proceso puede durar 2 horas o más, así que toca esperar. </li><br>
    
                    <li>Una vez los frijoles estén blandos es momento de echarle el consomé de costilla y sal al gusto, puedes ir echándole sal de a poco e ir revolviendo hasta encontrar el punto deseado.</li><br>
    
                    <li>Unos minutos después de echarle la sal y el consomé la sopa estará lista para consumir, retiramos del fuego y servimos.</li>
