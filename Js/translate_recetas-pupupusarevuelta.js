...
Log in
`
pupusarIngles = pupusarIngles.split("\n");
pupusarEspañol = pupusarEspañol.split("\n");
...
function  traducir(element) {
    ...
    if(element.id == "idioma-ingles"){   
        ...
        pupusarIngles.forEach((element, i) => {
            if(!element) return
             
            document.querySelector("[data-pupusar='"+i+"']").innerHTML = element;
        });
       ...
       lang = sessionStorage.getItem("lang");
        ...
        pupusarEspañol.forEach((element, i) => {
            if(!element) return
            document.querySelector("[data-pupusar='"+i+"']").innerHTML = element;
        });
