...
Log in
`
pupusafqIngles = pupusafqIngles.split("\n");
pupusafqEspañol = pupusafqEspañol.split("\n");
...
function  traducir(element) {
    ...
    if(element.id == "idioma-ingles"){   
        ...
        pupusafqIngles.forEach((element, i) => {
            if(!element) return
             
            document.querySelector("[data-pupusafq='"+i+"']").innerHTML = element;
        });
       ...
       lang = sessionStorage.getItem("lang");
        ...
        pupusafqEspañol.forEach((element, i) => {
            if(!element) return
            document.querySelector("[data-pupusafq='"+i+"']").innerHTML = element;
        });
